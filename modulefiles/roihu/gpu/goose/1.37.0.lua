...
setenv("APPTAINER_IMAGE", "/users/msalmens/agent-env/roihu-agent-env/images/goose-gpu-1.37.0.sif")
...
prepend_path("PATH", "/users/msalmens/agent-env/roihu-agent-env/bin/roihu/goose")
