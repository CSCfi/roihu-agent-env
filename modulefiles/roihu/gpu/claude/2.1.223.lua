...
help([[
This a containerized environment for running Claude in a more secure manner.

To avoid mounting your whole home directory, the container saves Claude's 
configuration to ~/roihu-claude. If you have used Claude on Roihu 
previously, you can keep your old configuration by running: 
    cp ~/.claude ~/roihu-claude
    cp ~/.claude.json ~/roihu-claude/.claude.json

This module provides the following commands:
* claude

More information:
* https://gitlab.ci.csc.fi/compen/hpc-support/roihu-agent-env
]])
...
setenv("AGENT_IMAGE", pathJoin(root, "images/claude-aarch64-2.1.223.sif"))
...
prepend_path("PATH", pathJoin(root, "bin/roihu/claude"))
