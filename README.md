...
- Apptainer definition file for installing [OpenCode](https://opencode.ai/docs), [Claude CLI](https://code.claude.com/docs/en/overview) and [Codex](https://learn.chatgpt.com/docs/codex/cli) inside a container.
